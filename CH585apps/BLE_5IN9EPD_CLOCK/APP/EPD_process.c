...
#define INIT_CACHE tmos_memset(imageCache,0x00,26928)

__attribute__((aligned(4))) __attribute__((section(".lowram"))) uint8_t imageCache[26928];//显存，放在低96k
...
uint16_t EPD_ProcessEvent(uint8_t task_id, uint16_t events)
{
    ...
    if(events & EPD_SHOWMSG_EVT)
    {
    	...
    	fastDrawString(790,271-16,"Received Msg:",font16);
    	fastDrawString(790,271-32,MsgToDisplay+1,font16);
